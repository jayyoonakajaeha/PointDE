"""
Usage:
python eval.py --data_dir {data_dir} --checkpoint {checkpoint_dir} --fold {fold_number} --sv_dir {save_folder}
"""
import sys
import argparse
...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=24, help='batch size in training [default: 16]')
